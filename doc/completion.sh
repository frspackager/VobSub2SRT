...
_vobsub2srt() {
    ...
    case $cur in
        -*)
            COMPREPLY=( $( compgen -W '--dump-images --invert-images --verbose --ifo --lang --langlist --tesseract-lang --tesseract-data --tesseract-oem --blacklist --y-threshold --min-width --min-height' -- "$cur" ) )
            ;;
        *)
